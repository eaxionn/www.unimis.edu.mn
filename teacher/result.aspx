...
<%@ Page Language="vb" AutoEventWireup="false" Inherits="teacher.result" CodeFile="result.aspx.vb" %>
		...
		<form id="Form1" method="post" runat="server">
			<table id="table1" cellspacing="0" cellpadding="0" width="1020" align="center" border="0">
				...
				<tr>
															...
															<td>
																<table id="table6" cellspacing="1" cellpadding="1" width="100%" border="0">
																	<tr>
																		...
																		<td align="right">
																			<asp:linkButton id="linkButton5" runat="server">Дvнгийн 
                            жагсаалт&nbsp;&nbsp;&nbsp;</asp:linkButton></td>
																	</tr>
																</table>
															</td>
														</tr>
                  ...
                  тавих оюутны дvнг -50 оруулна</asp:panel><asp:panel id="Panel2" runat="server" Visible="False"> 
                  <table id="table4" cellspacing="1" cellpadding="1" width="100%" border="0">
														<tr>
															<td align="center">
																...
																<asp:linkButton id="linkButton4" runat="server" Font-Italic="true"><< 
                              емнех</asp:linkButton>
																<asp:Label id="sid" runat="server" Font-Bold="true" ForeColor="#003399"></asp:Label>
																<asp:linkButton id="linkButton3" runat="server" Font-Italic="true">дараах 
                              >></asp:linkButton>
																...
																<asp:DataGrid id="DataGrid2" runat="server" Width="80%" AutoGenerateColumns="False" GridLines="Horizontal"
																	...
																	<Columns>
																		...
																		<asp:TemplateColumn headerText="Нэр">
																			<ItemTemplate>
																				<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.hname")&" /"&Format(DataBinder.Eval(Container, "DataItem.honoo"), "###0.00")&"/" %>'>
																				</asp:Label>
																			</ItemTemplate>
																		</asp:TemplateColumn>
																		...
																		<asp:TemplateColumn Visible="False" headerText="sname">
																			<ItemTemplate>
																				<asp:Label id="sname" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.sname") %>'>
																				</asp:Label>
																			</ItemTemplate>
																		</asp:TemplateColumn>
                  ...
                  тавих оюутны дvнг -50 
          оруулна</asp:panel></td>
										</tr>
									</table>
								</td>
								<td valign="top" width="100"><uc1:nomiinsan id="Nomiinsan1" runat="server"></uc1:nomiinsan><uc1:nuutsug id="Nuutsug1" runat="server"></uc1:nuutsug></td>
							</tr>
						</table>
					</td>
				</tr>
