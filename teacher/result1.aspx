<%@ Page Language="vb" AutoEventWireup="false" Inherits="teacher.result1" CodeFile="result1.aspx.vb" %>
<html>
	<head>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			...
			<table width="100%" border="0" align="left" cellpadding="1" cellspacing="1" id="table1">
				...
				<tr>
					<td><asp:Label ID="surName" runat="server" Text="Label" Font-Size="14px"></asp:Label>
					    <br />					    
					    <asp:datagrid id="DataGrid1" runat="server" Width="100%" HorizontalAlign="Center"
						headerStyle-BackColor="#CCCDDB" AutoGenerateColumns="False" AllowPaging="true" PageSize="50" >
