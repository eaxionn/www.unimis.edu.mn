...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Else
                If Not IsPostBack Then
                    Label2.Text = Request("lesscode") & " хичээлийн семинарын сэдэвчилсэн телевлегее"
                    Hyperlink1.NavigateUrl = "Standart.aspx?lesscode=" & Request("lesscode")
                    Dim sql As String
                    Dim i As Integer = 1
                    If myConnection.State = ConnectionState.Closed Then myConnection.Open()
                    sql = "select * from U0354_1 where U0354AA='" & Request("lesscode") & "' order by convert(int,U0354BB)"
                    Dim cmd = New SqlCommand(sql, myConnection)
        ...
        Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
            ...
            For i = 1 To 16
                ...
                'Call Seminaradd(Request("lesscode"), i, sedev.Text.Replace("'", "''"), temdeglel.Text.Replace("'", "''"), Session("tcode"))

                Dim strUpdateStmt As String
                strUpdateStmt = "if not exists (select * from U0354_1 where U0354AA='" & Request("lesscode") & "' and U0354BB=" & i & ")" & _
                " insert into U0354_1 values('" & Request("lesscode") & "'," & i & ",N'" & sedev.Text.Replace("'", "''") & "',N'" & temdeglel.Text.Replace("'", "''") & "',N'" & Session("tcode") & "') " & _
                " else " & _
                "update U0354_1 set U0354CC=N'" & sedev.Text.Replace("'", "''") & "',U0354DD=N'" & temdeglel.Text.Replace("'", "''") & "',U0354GG=N'" & Session("tcode") & "' where U0354AA=N'" & Request("lesscode") & "' and U0354BB=" & i
        ...
        Public Function Seminaradd(ByVal lessid As String, ByVal dhonog As Int16, ByVal sedev As String, ByVal temdeglel As String, ByVal tcode As String) As String
